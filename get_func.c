...
/**
 * get_func - This function selects the right function
 *
 * @parsed: The line from the bytecode file passed to main
 *
 * Return: The pointer to the selected function, NULL on failure
 */
...
/**
 * push_handler - This function handles the push instruction
 *
...
/**
 * pall_handler - This function handles the pall instruction
 *
 * @stack: A double-pointer to the stack to push to
 *
 * @line_number: The number of the line in the file
