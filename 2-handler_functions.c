...
/**
 * div_handler - This function handles the div instruction
 *
...
/**
 * mod_handler - Function which handles the mod instruction
 *
 * @stack: A double-pointer to the stack to push to
 *
 * @line_number: The number of the line in the file
...
/**
 * sub_handler - Function that handles the sub instruction
 *
 * @stack: A double-pointer to the stack to push to
 *
...
/**
 * mul_handler - A function that handles the mul instruction
 *
 * @stack: A double-pointer to the stack to push to
 *
 * @line_number: The number of the line in the file
